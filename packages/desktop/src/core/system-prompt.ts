import { THECHAT_LATEX_FORMATTING_INSTRUCTIONS } from "@thechat/shared";
...
${THECHAT_LATEX_FORMATTING_INSTRUCTIONS}
...
- Use **read** instead of cat, head, tail, or sed for reading files (also reads image files — PNG, JPEG, GIF, WebP — so you can see their contents; SVG files are read as text)
...
## Credentials
- For API keys or tokens you need, check environment variables or ask the user.
