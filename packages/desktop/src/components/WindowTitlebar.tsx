...
export function WindowTitlebar() {
  ...
  return (
    <div
      ...
      className="flex h-9 shrink-0 select-none items-center border-b border-border-subtle bg-surface/95 text-text-muted shadow-[0_1px_0_rgba(255,255,255,0.02)_inset]"
