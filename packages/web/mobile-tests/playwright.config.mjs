...
export default defineConfig({
  ...
  webServer: { command: "pnpm --filter @thechat/web exec vite --config mobile-tests/vite.config.mjs", cwd: path.resolve(here, "../../.."), url: "http://127.0.0.1:1433", reuseExistingServer: false },
});
